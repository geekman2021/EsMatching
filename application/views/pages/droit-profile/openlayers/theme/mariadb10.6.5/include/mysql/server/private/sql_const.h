...
<!-- $Id: nl.xml 699 2012-09-15 11:57:13Z namiltd $ -->
<!--
phpSysInfo language file Language: Dutch Created by: Jaap Struyk
-->
<tns:translation language="dutch" charset="utf-8"
 ...
 xsi:schemaLocation="http://phpsysinfo.sourceforge.net/translation translation.xsd">
  ...
  <expression id="008" name="users">
    <exp>Huidige gebruikers</exp>
  </expression>
  <expression id="009" name="loadavg">
    <exp>Gemiddelde belasting</exp>
  </expression>
  <expression id="010" name="hardware">
    <exp>Hardware overzicht</exp>
  </expression>
  ...
  <expression id="026" name="connections">
    <exp>Aktieve Netwerkverbindingen</exp>
  </expression>
  <expression id="027" name="memusage">
    <exp>Geheugengebruik</exp>
  </expression>
  <expression id="028" name="phymem">
    <exp>Fysiek geheugen</exp>
  </expression>
  <expression id="029" name="swap">
    <exp>Swap geheugen</exp>
  </expression>
  <expression id="030" name="fs">
    <exp>Aangesloten bestandssystemen</exp>
  </expression>
